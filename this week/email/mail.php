...
try {
    ...
    $mail->Username = "rdctech94@gmail.com";              // SMTP username
    $mail->Password = "ezrc tqxn wkha dnxb";                     // SMTP password

    // Specify recipients
    $mail->setFrom('rdctech94@gmail.com', 'RDC - TECH Website');      
    // $mail->addAddress('test.harishankar@gmail.com', 'name-is-optional');
